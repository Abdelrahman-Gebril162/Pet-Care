"""
Django settings for Pet_Care_Backend project.
...
SECRET_KEY = 'django-insecure-(y^$3r=jzg^k(ss*4vl5l)#xpljl!+qjf&be$gm)ij5vi#2h4&'
...
ROOT_URLCONF = 'Pet_Care_Backend.urls'
...
WSGI_APPLICATION = 'Pet_Care_Backend.wsgi.application'
...
#conf to add create media folder to upload image in
